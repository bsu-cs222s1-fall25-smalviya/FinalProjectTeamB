    ...
    public String getMoneyInfo(){
        ...
        if (PullOrBudgetInt.getText()==null){
            ...
            if (CalculationStyle.getValue() == "Calculate the cost of pulls") {
                double cost = money.calculateMoney(GameMoneyPick.getValue().toString(), getIntFromPullsOrBudget().intValue());
                ...
                double pulls = money.calculateBudget(GameMoneyPick.getValue().toString(), getIntFromPullsOrBudget());
